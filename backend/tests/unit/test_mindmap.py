...
class TestMindmapFormatting:
    ...
    def test_validate_mindmap_structure(self):
    ...
    def test_validate_mindmap_missing_nodes(self):
    ...
    def test_validate_mindmap_orphaned_edges(self):
    ...
    def test_format_mindmap_for_frontend(self):
